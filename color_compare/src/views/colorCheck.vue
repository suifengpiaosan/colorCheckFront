<template>
  ...
  <el-row  style="left:  0">
    ...
    <div class="btn">
      ...
      <button @click="changeColor">添加</button>
    </div>
  ...
  <el-row>
    <el-row>
      <el-col>
        <el-button type="success" @click="getResult">检查</el-button>
...
import {rgbaColor} from "vue3-colorpicker/types/utils/color";
...
function changeColor() {
  if (!isHex(attr.modelHex) || !isRgb(attr.modelRgb)) {
    ...
    rgbList.value.push(attr.modelHex)
  }
}
clearColor
function clearColor() {
...
function getResult() {
  ...
  let data = {"color_list":rgbList.value}
